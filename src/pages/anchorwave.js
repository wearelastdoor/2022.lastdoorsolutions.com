            ...
            <main className="main">
                ...
                <section className={`c-case-study-hero`}>
                    <div className={`container`}>
                        ...
                        <img src={anchorwave_logo} className="c-case-study-hero__logo" alt={`anchorwave branding`}/>
                        <h1 className={`c-case-study-hero__title`}>13+ years of working together.</h1>
                ...
                <div className={`c-case-study-intro`}>
                    <div className="container">
                        <div className="c-case-study-intro__content">
                            ...
                            <p>Anchorwave is a Tucson-based Web Design & Marketing Agency that helps businesses of all
                                sizes,
                                from small manufacturers who are just getting started or looking to expand their reach
                                online.</p>
                            <p>We’ve been working together since its inception, and our shared values have allowed
                                anchorwave to
                                grow into one of Tucson’s most reputable agencies for all things digital!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className={`c-concentration`}>
                    <div className={`container`}>
                        ...
                        <img className={`c-concentration__graphic`} src={welcome_illustration}
                ...
                <div className={`c-content`}>
                    <div className={`container`}>
                        <div className="c-content__card">
                            <h2 className={`c-content-card__title`}>Our story, not-story but the truth.</h2>
                            <p>We may have been on the other side of Earth, but we managed to work well together. Our
                                remote
                                partnership has lasted more than a decade, thanks in part to our coordination skills and
                                ability
                                to get stuff done.</p>
                            <p>With a team of dedicated designers and developers, we helped Anchorwave achieve its
                                client’s
                                goals.</p>
                            <p>We started with the website design work before catching up on technical support (and
                                more),
                                eventually leading to an in-house group that could handle all strategical needs and
                                those
                                pesky
                                little details like coding or building out everything from scratch.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={`container`}>
                        <div className={`c-list-content__card`}>
                            ...
                            <div className="c-list-content__tools">
                                <h3 className={`c-list-content__tools-title`}>TOOLS THAT HELP</h3>
                                <ul className="c-list-content__tools-list">
                                    <li>
                                        <img src={toolLogo1} alt="ConnectWise" style={{maxWidth: `191px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo2} alt="Sketch" style={{maxWidth: `157px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo3} alt="Suite" style={{maxWidth: `122px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo4} alt="Loom" style={{maxWidth: `125px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo5} alt="Dropbox" style={{maxWidth: `183px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo6} alt="Figma" style={{maxWidth: `131px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo7} alt="Invision" style={{maxWidth: `133px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo8} alt="liquid web" style={{maxWidth: `179px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo9} alt="basecamp" style={{maxWidth: `175px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo10} alt="Time Doctor" style={{maxWidth: `176px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo11} alt="Zoho" style={{maxWidth: `131px`}}/>
                                    </li>
                                    <li>
                                        <img src={toolLogo12} alt="AdobeXD" style={{maxWidth: `132px`}}/>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <section className={`c-accordion`}>
                    <div className={`container`}>
                        <div className="c-accordion__intro">
                            <h2 className={`c-accordion__heading`} title={`FAQs`}>FAQs</h2>
                        </div>
                        <div className={`c-accordion__item`}>
                            <div className={`c-accordion__header`}>
                                <h3 className={`c-accordion__title`}>How often do we have meetings?</h3>
                                <button type={`button`} className={`c-accordion__button`}><span
                                    className={`screen-reader-text`}>accordion action button</span>
                                </button>
                            </div>
                        ...
                        <div className={`c-accordion__item`}>
                            <div className={`c-accordion__header`}>
                                <h3 className={`c-accordion__title`}>How many resources do you allocate for
                                    Anchorwave?</h3>
                                <button type={`button`} className={`c-accordion__button`}><span
                                    className={`screen-reader-text`}>accordion action button</span>
                                </button>
                        ...
                        <div className={`c-accordion__item`}>
                            <div className={`c-accordion__header`}>
                                <h3 className={`c-accordion__title`}>What’s the most common type of project?</h3>
                                <button type={`button`} className={`c-accordion__button`}><span
                                    className={`screen-reader-text`}>accordion action button</span>
                                </button>
                            </div>
