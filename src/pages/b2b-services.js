          ...
          <div className={`l-container`}>
            <div className={`c-service-partner__grid`}>
              <div className={`c-service-partner__item`}>
                <div
                  className={`c-service-partner__card`}
                ...
                >
                  ...
                  >
                    <span className={`screen-reader-text`}>anchorwave</span>
                  </TransitionLink>
                </div>
              </div>
              <div className={`c-service-partner__item`}>
        ...
        <section className={"c-strategy"}>
          <div className="container">
            <div className={`c-strategy__header`}>
              <h2 className={`c-strategy__title`} title={`Capabilities`}>
                Capabilities
              </h2>
              <h3 className={`c-strategy__subtitle`}>
              ...
              <div className={`c-strategy__card`}>
                <div className="c-strategy__columns">
                  <section className="c-strategy__column">
                    ...
                    <p>
                      User Experience stands at the heart of our agency and
                      helps drive the products and projects to excellence.
                    </p>
                  </section>
                  <section className="c-strategy__column">
                    <h3 className={`c-strategy__columnTitle`}>
                      Product Strategy
                    </h3>
                    <p>
                      Understanding market needs and strategizing a product with
                      expert UX knowledge meanwhile keeping the human at center
                  ...
                  <section className="c-strategy__column">
                    ...
                    <p>
                      We build custom plugins bespoke to your needs when it
                      comes to security, tailor-made features, and project
                      needs.
                    </p>
                  </section>
                  <section className="c-strategy__column">
                    ...
                    <p>
                      We can literally do anything on WordPress, which makes us
                      an expert in delivering world-classs WooCommerce products.
                    </p>
                  </section>
                  <section className="c-strategy__column">
                    <h3 className={`c-strategy__columnTitle`}>
                  ...
                  <section className="c-strategy__column">
                    ...
                    <p>
                      Faster and quicker frontend delivery with custom design
                      and less hassle, we ship awesome sites.
                    </p>
                  </section>
                  <section className="c-strategy__column">
                    <h3 className={`c-strategy__columnTitle`}>
                    ...
                    <p>
                      We do understand and care about our small size customers
                      so we have covered you here as well.
                    </p>
                  </section>
                </div>
              </div>
